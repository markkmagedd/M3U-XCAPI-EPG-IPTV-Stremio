...
// This ensures Stremio always gets the full manifest with up-to-date genres.
...
// Stremio router (handles catalog, stream, meta)
...
app.listen(port, () => {
  console.log(
    `🚀 Server running on port ${port} (debug=${DEBUG}, prefetch=${PREFETCH_ENABLED})`,
  );
});
